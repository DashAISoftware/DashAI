import type { IParameterJsonSchema, IDefaultValues } from "../types/configurableObject";
import {
...
export const getFullDefaultValues = async (parameterJsonSchema: IParameterJsonSchema, choice: string = "none"): Promise<object> => {
