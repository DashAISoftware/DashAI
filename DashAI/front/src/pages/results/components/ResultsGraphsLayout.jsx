...
function ResultsGraphsLayout({ selectedChart, handleChangeChart, showCustomMetrics,
                               handleToggleMetrics, tabularMetrics, selectedParameters,
                               handleToggleParameter, selectedGeneralMetric, setSelectedGeneralMetric,
                               setSelectedParameters, concatenatedMetrics, chartData }) {
  return (
