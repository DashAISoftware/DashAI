            ...
            {runData[displaySet] === null ? (
              runData.status === 3 ? (
                ...
                <Alert severity="warning" sx={{ mb: 2 }}>
                  <AlertTitle>
                    {`There are no metrics associated with the ${getDisplaySetName(displaySet)} set in this run`}
                  </AlertTitle>
                  Go to{" "}
              ...
              <Alert severity="error" sx={{ mb: 2 }}>
                ...
                <Typography variant="body1">
                  The result metrics for {getDisplaySetName(displaySet)} set are empty.
                </Typography>
              </Alert>
            ) : (
