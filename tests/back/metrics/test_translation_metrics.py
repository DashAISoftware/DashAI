...
def test_bleu(dataset: DatasetDict):
    pred_opus_mt_en_es = dataset["test"][1]
    score = Bleu.score(dataset["test"][1], pred_opus_mt_en_es)
...
def test_ter(dataset: DatasetDict):
    pred_opus_mt_en_es = dataset["test"][1]
    score = Ter.score(dataset["test"][1], pred_opus_mt_en_es)
