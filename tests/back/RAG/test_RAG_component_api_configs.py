...
class TestEncodingModels:
    ...
    def test_encoding_bm25_default(self, client: TestClient):
    ...
    def test_encoding_bm25_custom_hyperparams(self, client: TestClient):
    ...
    def test_encoding_tfidf_default(self, client: TestClient):
    ...
    def test_encoding_tfidf_custom(self, client: TestClient):
    ...
    def test_encoding_dense_sentence_transformer(self, client: TestClient):
    ...
    def test_encoding_dense_st_alt(self, client: TestClient):
        """DenseEmbeddingRetriever + SentenceTransformerEmbedding (all-MiniLM-L6-v2)."""
        params = _base_params()
...
class TestRankingFunctions:
    ...
    def test_ranking_dense_cosine(self, client: TestClient):
    ...
    def test_ranking_dense_euclidean(self, client: TestClient):
    ...
    def test_ranking_sparse_manhattan(self, client: TestClient):
    ...
    def test_ranking_mmr_reranker(self, client: TestClient):
...
class TestTopK:
    ...
    def test_topk_bm25_3(self, client: TestClient):
    ...
    def test_topk_tfidf_5(self, client: TestClient):
    ...
    def test_topk_dense_st_10(self, client: TestClient):
    ...
    def test_topk_dense_st_15(self, client: TestClient):
    ...
    def test_topk_bm25_20(self, client: TestClient):
    ...
    def test_topk_mmr_12(self, client: TestClient):
...
class TestChunkingStrategies:
    ...
    def test_chunking_char_small(self, client: TestClient):
    ...
    def test_chunking_char_paragraph(self, client: TestClient):
    ...
    def test_chunking_char_page(self, client: TestClient):
    ...
    def test_chunking_recursive_custom(self, client: TestClient):
    ...
    def test_chunking_token_e5_mistral(self, client: TestClient):
    ...
    def test_chunking_token_bert_spanish(self, client: TestClient):
...
class TestPrompts:
    ...
    def test_prompt_default_rag_en(self, client: TestClient):
    ...
    def test_prompt_default_rag_es(self, client: TestClient):
    ...
    def test_prompt_default_qna_en(self, client: TestClient):
    ...
    def test_prompt_custom_template(self, client: TestClient):
...
class TestGeneratorModels:
    ...
    def test_generator_llama_1b_default(self, client: TestClient):
    ...
    def test_generator_llama_3b_custom(self, client: TestClient):
    ...
    def test_generator_mistral_7b_default(self, client: TestClient):
    ...
    def test_generator_qwen_0_5b_default(self, client: TestClient):
    ...
    def test_generator_qwen_1_5b_custom(self, client: TestClient):
    ...
    def test_generator_smol_1_7b_default(self, client: TestClient):
    ...
    def test_generator_phi4_mini_default(self, client: TestClient):
